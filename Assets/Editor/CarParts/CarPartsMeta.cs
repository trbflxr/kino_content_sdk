...
namespace Editor {
	...
	public class CarPartsMeta : ScriptableObject {
		[Serializable]
		public class Proxy {
			public ulong Id;
			public int Type;
		...
		public static IEnumerable<CarPartsMeta> GetAllInstances() {
			var guids = AssetDatabase.FindAssets($"t:{nameof(CarPartsMeta)}");

			var packsList = new List<CarPartsMeta>();

			foreach (var guid in guids) {
				string path = AssetDatabase.GUIDToAssetPath(guid);
				var meta = AssetDatabase.LoadAssetAtPath<CarPartsMeta>(path);
