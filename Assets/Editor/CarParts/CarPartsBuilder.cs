...
namespace Editor {
	public class CarPartsBuilder {
		public void Build(BuildTarget target, CarPartsBuilderMeta builder, AuthorMeta author, IReadOnlyCollection<CarPartsMeta> packs) {
		...
		private void BuildPackBundle(BuildTarget target, CarPartsBuilderMeta builder, AuthorMeta author, CarPartsMeta pack) {
			...
			string packFileName = $"{pack.PackName}{builder.Ext}";
