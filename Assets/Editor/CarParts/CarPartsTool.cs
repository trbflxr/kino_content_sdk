...
namespace Editor {
	public class CarPartsTool : EditorWindow {
		private const float OFFSET = 5.0f;

		private static AuthorMeta authorMeta_;
		private static CarPartsBuilderMeta builderMeta_;
		private readonly List<CarPartsMeta> packs_ = new();

		private readonly CarPartsBuilder builder_ = new();
		...
		private void Refresh() {
			...
			builderMeta_ = CarPartsBuilderMeta.GetInstance();

			packs_.Clear();
			packs_.AddRange(CarPartsMeta.GetAllInstances());
		}
	}
}